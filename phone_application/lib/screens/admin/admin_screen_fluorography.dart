...
class AdminScreenFluorography extends ConsumerStatefulWidget {
  const AdminScreenFluorography({super.key});
                ...
                child: Padding(
                  ...
                  child: filteredGroupsAsync.when(
                    data: (groups) {
                      ...
                      return AdminConstructorAccordionBuildWidget(groups: groups);
                    },
